...
contract Owned {
    ...
    constructor(address p_owner) public {
        owner = p_owner;
    }
...
contract OP_ERC20 is ERC20Interface, Owned {
...
////-----------------------------------------------
    ...
    // Constructor
    // ------------------------------------------------------------------------
    constructor(address p_owner, uint256 p_total ,string memory p_symbol , string memory p_name , uint8 p_decimals  )  Owned(p_owner) public {
       
        symbol = p_symbol;
        name = p_name;
        decimals = p_decimals;
        _totalSupply = p_total;
